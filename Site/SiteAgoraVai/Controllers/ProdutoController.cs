...
namespace SiteAgoraVai.Controllers
{
    public class ProdutoController : Controller
    {
        ...
        public ProdutoController(MainContext context)
        {
            _context = context;
        }
        ...
        public async Task<IActionResult> Create([Bind("Id,Nome,Quantidade,PrecoUnitario")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,Nome,Quantidade,PrecoUnitario")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
