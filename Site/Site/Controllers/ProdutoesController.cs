...
namespace Site.Controllers
{
    public class ProdutoesController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,nome,tipo,quantidade,preco_unitario")] Produto produto)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,nome,tipo,quantidade,preco_unitario")] Produto produto)
        {
            if (id != produto.Id)
            {
                return NotFound();
